...
test('it should detect `Google Chrome` `v71` running in `Macintosh`', () => {
  const testData = {
...
test('it should detect `Google Chrome` `v60` running in `Windows`', () => {
  const testData = {
...
test('it should detect `Google Chrome` `v56` running in `Linux`', () => {
  const testData = {
...
test('it should detect `Google Chrome` `v70` running in `Chrome OS`', () => {
  const testData = {
...
test('it should detect `Google Chrome` `v60` running in `IPad`', () => {
  const testData = {
...
test('it should detect `Google Chrome` `v56` running in `IPhone`', () => {
  const testData = {
...
test('it should detect `Google Chrome` `v18` running in `Android`', () => {
  const testData = {
...
test('it should detect `Google Chrome` `v58` running in `Android Tablet`', () => {
  const testData = {
